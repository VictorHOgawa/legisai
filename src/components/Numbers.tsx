    ...
    <div className="mt-8 flex flex-col gap-8">
      <div className="relative flex h-full w-full flex-col items-center justify-evenly lg:h-40 lg:flex-row">
        ...
        <span className="mx-auto w-[90%] text-lg font-semibold lg:w-2/5 lg:text-2xl">
          Veja os Números atualizados diariamente sobre todo o uso da Plataforma
          Legis AI pelos usuários e quais sãos as funcionalidades mais populares
        </span>
        <Image
          src="/logoWhitee.png"
          alt=""
      ...
      <div className="mx-auto flex w-[95%] flex-col gap-4 lg:flex-row">
        <div ref={ref1} className="flex w-full flex-col gap-4">
          <div
            className={twMerge(
              "flex translate-x-28 flex-col opacity-0 transition delay-200 duration-500 ease-in-out",
              isVisible1 && "translate-x-0 opacity-100",
            )}
          >
          ...
          <div
            className={twMerge(
              "flex translate-x-28 flex-col opacity-0 transition delay-[400ms] duration-500 ease-in-out",
              isVisible1 && "translate-x-0 opacity-100",
            )}
          >
            <div className="flex items-center gap-2">
          ...
          <div
            className={twMerge(
              "flex translate-x-28 flex-col opacity-0 transition delay-[600ms] duration-500 ease-in-out",
              isVisible1 && "translate-x-0 opacity-100",
            )}
          >
            <div className="flex items-center gap-2">
          ...
          <button className="group flex w-full items-center gap-2 rounded-full border border-[#00A15D] p-2 transition duration-200 hover:border-primary hover:bg-primary lg:w-max">
            ...
            <span>
              CLIQUE AQUI PARA VER MAIS DAS <strong>FUNÇÕES MAIS USADAS</strong>
            </span>
          </button>
        </div>
        <div ref={ref2} className="flex w-full flex-col gap-4">
          <div
            className={twMerge(
              "flex w-full translate-y-20 items-center gap-4 opacity-0 transition delay-200 duration-500 ease-in-out",
              isVisible2 && "translate-y-0 opacity-100",
            )}
          >
          ...
          <div
            className={twMerge(
              "flex w-full translate-y-20 items-center gap-4 opacity-0 transition delay-[400ms] duration-500 ease-in-out",
              isVisible2 && "translate-y-0 opacity-100",
            )}
          >
          ...
          <div
            className={twMerge(
              "flex w-full translate-y-20 items-center gap-4 opacity-0 transition delay-[600ms] duration-500 ease-in-out",
              isVisible2 && "translate-y-0 opacity-100",
            )}
          >
            <div className="flex h-32 w-full flex-col rounded-md bg-[#202020] p-2 xl:h-auto xl:p-4">
